  ...
  return (
    <div id="huong-dan-mua-hang">
      ...
      <p>
        ...
        <a href="/huong-dan-thanh-toan" className="muahang-red">
          Hướng dẫn chuyển khoản qua ngân hàng
        </a>. Bên cạnh đó chúng tôi cũng khuyến khích quý vị liên lạc qua zalo
        hoặc Facebook messenger để dễ dàng trao đổi đầy đủ nhất về thông tin sản
        phẩm.
      </p>
      <p>
        <strong>Bước 3:</strong> Sau khi nhận tiền đặt cọc chúng tôi sẽ tiến
        hành chuyển hàng cho quý khách thông qua công ty chuyển phát nhanh J&T,
        thời gian giao hàng từ 1 đến 7 ngày tùy từng khu vực, đối với những đơn
        hàng có vị trí gần chúng tôi sẽ vận chuyển bằng ô tô. Nhân viên giao
        hàng sẽ thu nốt số tiền còn lại khi bàn giao sản phẩm trực tiếp tại nhà
        cho khách hàng.{" "}
        <a href="/chinh-sach-van-chuyen" className="muahang-red">
      ...
      <p>
        ...
        {/* Đổi thành Hotline BeeShop */}
        <strong>Hotline BeeShop: 0813783419</strong>.{" "}
        <a href="/doi-tra" className="muahang-red">
          Xem thêm quy định đổi trả sản phẩm tại đây
        </a>.
      </p>
      <p>
        <strong>Lưu ý:</strong> Tên sản phẩm luôn đi kèm với kích thước theo thứ
        tự chiều cao, giá cả, màu sắc để quý khách tiện ước lượng
      </p>
      ...
      <p>
        ...
        {/* Đổi thành Hotline BeeShop */}
        <strong>Hotline BeeShop: 0813783419</strong> và vui lòng cung cấp cho
        chúng tôi các thông tin sau:
      </p>
      <ul>
